...
async Task SendHelp(long chatId)
{
    await botClient.SendMessage(chatId,
        "🏦 Бот управления кредитом и финансами\n\n" +
        "📋 Доступные команды:\n\n" +
        "🔐 Авторизация:\n" +
        ...
        "/fin_add_expense - добавить расход (интерактивно)\n" +
        "/fin_history [месяц] - история расходов с пагинацией и редактированием\n" +
        "/fin_analytics - аналитика расходов с выбором месяца и графиком\n\n" +
        "🎭 Прочее:\n" +
        "/gav - гаф\n\n" +
        "💡 Используйте команды в соответствии с вашими правами доступа");
}
